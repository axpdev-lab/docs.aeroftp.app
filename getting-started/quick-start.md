...
At the top of the screen you will find the **protocol selector** -- a categorized grid of every supported protocol. Below the selector are the connection input fields that adapt based on your chosen protocol.
...
<!-- SCREENSHOT: The protocol selector fully expanded, showing the grid of protocol cards organized by category. Every protocol card visible with its logo. Dark theme. -->
...
- **[Protocols Overview](../protocols/overview.md)** -- Guide to the supported protocols
