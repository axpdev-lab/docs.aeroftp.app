...
| **AeroAgent** | AI chat assistant with 39 tools for file management, code analysis, shell execution, archive operations, and server management across every protocol AeroFTP supports |
