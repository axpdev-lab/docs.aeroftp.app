...
- **AeroAgent** - AI-powered file management with 39 tools, multi-step autonomous execution, 24 AI providers
...
- **CLI** - 94 commands, batch scripting (.aeroftp), glob patterns, JSON output, exit codes
